                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {exchange.status === "disponible" && (
                        <>
                          <button
                            onClick={() =>
                              handleStatusChange(exchange._id, "pausado")
                            }
                          ...
                          <button
                            onClick={() =>
                              handleStatusChange(exchange._id, "en-progreso")
                            }
                      ...
                      {exchange.status === "pausado" && (
                        <button
                          onClick={() =>
                            handleStatusChange(exchange._id, "disponible")
                          }
                      ...
                      {exchange.status === "en-progreso" && (
                        <>
                          ...
                          <button
                            onClick={() =>
                              handleStatusChange(exchange._id, "intercambiado")
                            }
                            className="px-4 py-2 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition text-sm font-medium"
                          >
                            Marcar completado
