...
export const getExchangeByIdRequest = (id) => axios.get(`/exchanges/${id}`);

// Obtener mis trueques
export const getMyExchangesRequest = () => axios.get("/my-exchanges");
...
// Eliminar trueque
export const deleteExchangeRequest = (id) => axios.delete(`/exchanges/${id}`);
